...
<nav
    class="navbar navbar-expand-lg blur border-radius-lg top-0 z-index-3 shadow position-absolute mt-2 py-2 start-0 end-0 mx-4">
    <div class="container-fluid ps-2 pe-0">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 d-flex flex-column" href="{{ route('dashboard') }}">
            <h4>Sekawan Vehicle</h4> 
        </a>
        ...
        <div class="collapse navbar-collapse d-lg-flex justify-content-lg-end" id="navigation">
            <ul class="navbar-nav">
                <li class="nav-item">
